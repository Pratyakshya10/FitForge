    ...
    return(
        <>
            ...
            <ol classname="benefits-list">
                <li>Follow a simple proogram with guaranteed results</li>
            ...
            <ul className="rules-list">
                ...
                <div className="rule-item">
                    <p><b>Reps</b></p>
                    <p>Every rep is a pause rep following a <abbr title="2 seconds down - 2seconds pause -2 seconds up">2-2-2 tempo</abbr></p>
                </div>
                <div className="rule-item">
                    <p><b>Weight</b></p>
            ...
            <p>Complete all of the workouts below and track your progress
                along the way. ✅
            </p>
        </>
    )
